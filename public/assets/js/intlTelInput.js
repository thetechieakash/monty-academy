          ...
          , h = function() {
            ...
            n = [{
                ...
                value: function e(i, n, a) {
                    n.length > this.countryCodeMaxLen && (this.countryCodeMaxLen = n.length),
                    this.countryCodes.hasOwnProperty(n) || (this.countryCodes[n] = []);
                    for (var o = 0; o < this.countryCodes[n].length; o++)
                        if (this.countryCodes[n][o] === i)
                            return;
                    var s = a !== t ? a : this.countryCodes[n].length;
                    this.countryCodes[n][s] = i
                }
            }, {
                key: "_processAllCountries",
                value: function t() {
                    if (this.options.onlyCountries.length) {
                        var i = this.options.onlyCountries.map(function(t) {
                ...
                value: function t() {
                    for (var e = 0; e < this.countries.length; e++) {
                        ...
                        this.options.localizedCountries.hasOwnProperty(i) && (this.countries[e].name = this.options.localizedCountries[i])
                    }
                }
            }, {
                ...
                value: function t() {
                    ...
                    for (var e = 0; e < this.countries.length; e++) {
                        ...
                        this.dialCodes[i.dialCode] || (this.dialCodes[i.dialCode] = !0),
                        this._addCountryCode(i.iso2, i.dialCode, i.priority)
                    }
                    for (var n = 0; n < this.countries.length; n++) {
                        var a = this.countries[n];
                        if (a.areaCodes)
                            for (var o = this.countryCodes[a.dialCode][0], s = 0; s < a.areaCodes.length; s++) {
                                for (var r = a.areaCodes[s], l = 1; l < r.length; l++) {
                                    var u = a.dialCode + r.substr(0, l);
                                    this._addCountryCode(o, u),
                ...
                value: function t() {
                    ...
                    if (this.telInput.parentNode.insertBefore(i, this.telInput),
                    ...
                    this.options.hiddenInput) {
                        ...
                        if (a) {
                            var o = a.lastIndexOf("[");
                            -1 !== o && (n = "".concat(a.substr(0, o), "[").concat(n, "]"))
                        }
                ...
                value: function t(e, i, n) {
                    for (var a = "", o = 0; o < e.length; o++) {
                        var s = e[o]
                          , r = n ? "-preferred" : "";
                        a += "<li class='iti__country ".concat(i, "' tabIndex='-1' id='iti-").concat(this.id, "__item-").concat(s.iso2).concat(r, "' role='option' data-dial-code='").concat(s.dialCode, "' data-country-code='").concat(s.iso2, "' aria-selected='false'>"),
                ...
                value: function t() {
                    var e = this.telInput.getAttribute("value")
                      ...
                      , n = e && "+" === e.charAt(0) && (!i || "+" !== i.charAt(0)) ? e : i
                      , a = this._getDialCode(n)
                      , o = this._isRegionlessNanp(n)
                      , s = this.options
                      , r = s.initialCountry
                      , l = s.nationalMode
                      , u = s.autoHideDialCode
                      , d = s.separateDialCode;
                    a && !o ? this._updateFlagFromNumber(n) : "auto" === r || (r ? this._setFlag(r.toLowerCase()) : a && o ? this._setFlag("us") : (this.defaultCountry = this.preferredCountries.length ? this.preferredCountries[0].iso2 : this.countries[0].iso2,
                    n || this._setFlag(this.defaultCountry)),
                    n || l || u || d || (this.telInput.value = "+".concat(this.selectedCountryData.dialCode))),
                ...
                value: function t() {
                    ...
                    i && i.addEventListener("click", this._handleLabelClick),
                ...
                key: "_toggleClass",
                value: function t(e, i, n) {
                    n && !e.classList.contains(i) ? e.classList.add(i) : !n && e.classList.contains(i) && e.classList.remove(i)
                }
            }, {
                ...
                value: function t() {
                    ...
                    !this.isMobile) {
                        var i = this.telInput.getBoundingClientRect()
                          ...
                          , s = a + this.telInput.offsetHeight + o < n + window.innerHeight
                          , r = a - o > n;
                        if (this._toggleClass(this.countryList, "iti__country-list--dropup", !s && r),
                        this.options.dropdownContainer) {
                            var l = !s && r ? 0 : this.telInput.offsetHeight;
                ...
                value: function t(e) {
                    for (var i = e; i && i !== this.countryList && !i.classList.contains("iti__country"); )
                        i = i.parentNode;
                ...
                value: function t() {
                    ...
                    this._handleKeydownOnDropdown = function(t) {
                        t.preventDefault(),
                        "ArrowUp" === t.key || "Up" === t.key || "ArrowDown" === t.key || "Down" === t.key ? e._handleUpDownKey(t.key) : "Enter" === t.key ? e._handleEnterKey() : "Escape" === t.key ? e._closeDropdown() : /^[a-zA-ZÀ-ÿа-яА-Я ]$/.test(t.key) && (a && clearTimeout(a),
                        n += t.key.toLowerCase(),
                ...
                value: function t(e) {
                    var i = "ArrowUp" === e || "Up" === e ? this.highlightedItem.previousElementSibling : this.highlightedItem.nextElementSibling;
                    i && (i.classList.contains("iti__divider") && (i = "ArrowUp" === e || "Up" === e ? i.previousElementSibling : i.nextElementSibling),
                    this._highlightListItem(i, !0))
                }
            }, {
                key: "_handleEnterKey",
                value: function t() {
                ...
                value: function t(e) {
                    for (var i = 0; i < this.countries.length; i++)
                        if (this._startsWith(this.countries[i].name, e)) {
                            var n = this.countryList.querySelector("#iti-".concat(this.id, "__item-").concat(this.countries[i].iso2));
                ...
                value: function t(e) {
                    ...
                    if (this.options.formatOnDisplay && window.intlTelInputUtils && this.selectedCountryData) {
                        var n = !this.options.separateDialCode && (this.options.nationalMode || "+" !== i.charAt(0))
                          ...
                          , o = a.NATIONAL
                          , s = a.INTERNATIONAL;
                        i = intlTelInputUtils.formatNumber(i, this.selectedCountryData.iso2, n ? o : s)
                    }
                ...
                value: function t(e) {
                    ...
                    i && this.options.nationalMode && "1" === n && "+" !== i.charAt(0) && ("1" !== i.charAt(0) && (i = "1".concat(i)),
                    i = "+".concat(i)),
                    this.options.separateDialCode && n && "+" !== i.charAt(0) && (i = "+".concat(n).concat(i));
                    var a = this._getDialCode(i, !0)
                    ...
                    if (a) {
                        ...
                        "+" === i.charAt(0) && o.length ? s = "" : i && "+" !== i || (s = this.defaultCountry);
                ...
                value: function t(i, n, a) {
                    for (var o = n ? e : this.countries, s = 0; s < o.length; s++)
                        if (o[s].iso2 === i)
                            return o[s];
                    if (a)
                        return null;
                    throw Error("No country data for '".concat(i, "'"))
                }
            }, {
                key: "_setFlag",
                value: function t(e) {
                    ...
                    if (this.selectedFlag.setAttribute("title", n),
                    ...
                    this.options.allowDropdown) {
                        ...
                        e) {
                            ...
                            this.activeItem = r,
                            this.selectedFlag.setAttribute("aria-activedescendant", r.getAttribute("id"))
                        }
                    }
                    return i.iso2 !== e
                }
                ...
                value: function t() {
                    ...
                    var i = this.flagsContainer.cloneNode();
                    e.appendChild(i);
                ...
                value: function t(e, i) {
                    var n = this.countryList
                      ...
                      , o = n.offsetHeight
                      , s = n.getBoundingClientRect().top + a
                      , r = e.offsetHeight
                      , l = e.getBoundingClientRect().top + a
                      , u = l - s + n.scrollTop
                      , d = o / 2 - r / 2;
                    l < s ? (i && (u -= d),
                    n.scrollTop = u) : l + r > s + o && (i && (u += d),
                    n.scrollTop = u - (o - r))
                }
            }, {
                key: "_updateDialCode",
                value: function t(e, i) {
                    var n, a = this.telInput.value, o = "+".concat(e);
                    if ("+" === a.charAt(0)) {
                        ...
                        if (!i && this.options.autoHideDialCode)
                            return;
                        n = o
                    }
                    ...
                    if ("+" === e.charAt(0))
                        for (var a = "", o = 0; o < e.length; o++) {
                            ...
                            if (!isNaN(parseInt(s, 10))) {
                                if (a += s,
                                i)
                                    this.countryCodes[a] && (n = e.substr(0, o + 1));
                                else if (this.dialCodes[a]) {
                                    n = e.substr(0, o + 1);
                                    break
                                }
                                if (a.length === this.countryCodeMaxLen)
                                    break
                            }
                        }
                    return n
                ...
                key: "_getFullNumber",
                value: function t() {
                    var e, i = this.telInput.value.trim(), n = this.selectedCountryData.dialCode, a = this._getNumeric(i);
                    return (e = this.options.separateDialCode && "+" !== i.charAt(0) && n && a ? "+".concat(n) : "") + i
                }
            }, {
                ...
                value: function t(e) {
                    ...
                    if (this.options.separateDialCode) {
                        ...
                        if (n) {
                            var a = " " === i[(n = "+".concat(this.selectedCountryData.dialCode)).length] || "-" === i[n.length] ? n.length + 1 : n.length;
                            i = i.substr(a)
                        }
                    }
                    return this._cap(i)
                ...
                value: function t() {
                    ...
                    return window.intlTelInputUtils ? intlTelInputUtils.isValidNumber(e, i) : null
                }
            }, {
                key: "setCountry",
                value: function t(e) {
                    var i = e.toLowerCase();
                    this.selectedFlagInner.classList.contains("iti__".concat(i)) || (this._setFlag(i),
